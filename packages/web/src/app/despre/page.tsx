  ...
  return (
    <div className="py-8 max-w-3xl mx-auto space-y-8">
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6">
        <h2 className="text-lg font-bold text-emerald-800 mb-3">Echipa</h2>
        ...
        <div className="flex gap-3">
          <Link href="/cum-functioneaza" className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-sm font-medium hover:bg-emerald-700 transition-colors">
            Cum functioneaza
          </Link>
          <Link href="/" className="px-4 py-2 border border-emerald-300 text-emerald-700 rounded-xl text-sm font-medium hover:bg-emerald-100 transition-colors">
